...
void main() {
  testWidgets(
      'Widget login validación @ email', (WidgetTester tester) async {
       ...
       await tester.enterText(find.byKey(const Key('TextFormFieldLoginEmail')), 'aa.com');
       await tester.enterText(find.byKey(const Key('TextFormFieldLoginPassword')), '215694');
  ...
  testWidgets('Widget login validación número de caracteres password',
      ...
      await tester.pumpWidget(const GetMaterialApp(
       ...
       await tester.enterText(find.byKey(const Key('TextFormFieldLoginPassword')), '21569');
       await tester.tap(find.byKey(const Key('ButtonLoginSubmit')));
       await tester.pump();
  ...
  testWidgets(
      ...
      await tester.pumpWidget(const GetMaterialApp(
       ...
       await tester.enterText(find.byKey(const Key('TextFormFieldSignUpEmail')), 'aa.com');
  ...
  testWidgets(
      ...
      await tester.pumpWidget(const GetMaterialApp(
        home: HomePage(loggedEmail: 'loggedEmail', loggedPassword: 'loggedPassword'),
        ));
